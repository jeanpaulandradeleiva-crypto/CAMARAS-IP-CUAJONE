...
El inventario de binarios y hashes se incluye además en `docs/sbom.spdx.json`
(SPDX 2.3). Las dependencias de desarrollo/QA `jsonschema`, `pybind11`, Supervision y
